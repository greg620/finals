...
ActiveRecord::Schema.define(version: 20171019203256) do
  ...
  create_table "likes", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "commentable", default: "post"
  end
  ...
  create_table "tutoriels", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=latin1" do |t|
    t.string "title"
    t.string "slug"
    t.integer "user_id"
    t.text "content"
